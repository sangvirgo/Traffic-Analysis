...
class MainApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture('http://127.0.0.1:5000/video/Le Van Viet.mp4')  # Thay bằng đường dẫn tới video của bạn
        ...
        self.video_paths= {
            "Lê Văn Việt": "http://127.0.0.1:5000/video/Le Van Viet.mp4",
            "Võ Văn Ngân": "http://127.0.0.1:5000/video/Vo Van Ngan.mp4",
            "Võ Văn Kiệt": "http://127.0.0.1:5000/video/Vo Van Kiet.mp4",
            "Hai Bà Trưng": "http://127.0.0.1:5000/video/Hai Ba Trung.mp4",
            "Võ Chí Công": "http://127.0.0.1:5000/video/Vo Chi Cong.mp4",
        }
